...
# ⚠️ IMPORTANTE: ELIGE UNA de estas URIs (NO ambas)
# Opción 1: Usar localhost
YOUTUBE_REDIRECT_URI = config('YOUTUBE_REDIRECT_URI')

# Opción 2: Usar 127.0.0.1 (comentar la anterior y descomentar esta)
# YOUTUBE_REDIRECT_URI = 'http://127.0.0.1:8000/oauth/callback/'
...
LOGIN_URL = '/'
LOGIN_REDIRECT_URL = 'youtube_dashboard'
LOGOUT_REDIRECT_URL = '/'

# Session settings (IMPORTANTE para OAuth)
SESSION_ENGINE = 'django.contrib.sessions.backends.db'
SESSION_COOKIE_NAME = 'youtube_session'
...
# Tamaño máximo para subida de archivos (ajustar según necesidades)
...
YOUTUBE_MAX_UPLOAD_SIZE = 128 * 1024 * 1024